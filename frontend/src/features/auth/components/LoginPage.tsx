        ...
        <div className="w-full max-w-md">
          ...
          <div className="island-shell p-8 rounded-3xl transition-all duration-500 shadow-2xl shadow-violet-500/10">
            <form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
              ...
              <Button disabled={loading} className="w-full h-12 bg-linear-to-r from-violet-600 to-fuchsia-500 hover:from-violet-700 hover:to-fuchsia-600 text-white rounded-xl mt-4 shadow-lg shadow-violet-500/25 group transition-all duration-300 border-none">
                {loading ? (
