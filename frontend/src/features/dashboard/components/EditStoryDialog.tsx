      ...
      >
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-lg font-semibold text-(--sea-ink)">Edit Story</h2>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="edit-title" className="block text-sm font-medium text-(--sea-ink) mb-1.5">
              Story Title *
            </label>
            <Input
              id="edit-title"
          ...
          <div>
            <label htmlFor="edit-description" className="block text-sm font-medium text-(--sea-ink) mb-1.5">
